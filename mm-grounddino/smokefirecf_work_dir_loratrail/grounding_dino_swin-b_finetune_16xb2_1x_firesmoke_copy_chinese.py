...
class_path = '/home/cxc/mm-grounddino/data/smoke_fire/test/class_merge_chinese.txt'
classes = [
    '烟',
    '火',
    '云',
...
lang_model_name = 'bert-base-chinese'
launcher = 'pytorch'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='test/coco_annotations_v1_merge_chinese.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file=
    '/home/cxc/mm-grounddino/data/smoke_fire/test/coco_annotations_v1_merge_chinese.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    batch_size=3,
    dataset=dict(
        ann_file='train/coco_annotations_v1_ftmerge_chinese.json',
        backend_args=None,
