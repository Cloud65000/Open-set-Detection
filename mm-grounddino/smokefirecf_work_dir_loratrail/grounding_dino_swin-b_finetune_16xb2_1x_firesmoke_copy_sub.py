...
data_root = '/home/cxc/mm-grounddino/data/smoke_fire_demo/'
...
launcher = 'none'
load_from = '/home/cxc/mm-grounddino/weights/official/groundingdino_swinb_cogcoor_mmdet-55949c9c.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            ...
            adaptmlp=dict(lr_mult=0.1),
            backbone=dict(lr_mult=0.1),
            language_model=dict(lr_mult=0),
            lora_a=dict(decay_mult=1.0, lr_mult=0.1),
            lora_b=dict(decay_mult=1.0, lr_mult=0.1),
            lora_c=dict(decay_mult=1.0, lr_mult=0.1),
            lora_d=dict(decay_mult=1.0, lr_mult=0.1),
            lora_e=dict(decay_mult=1.0, lr_mult=0.1),
            lora_f=dict(decay_mult=1.0, lr_mult=0.1))),
    type='OptimWrapper')
param_scheduler = [
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='test/labels/coco_annotations_v1_merge_sub.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file=
    '/home/cxc/mm-grounddino/data/smoke_fire_demo/test/labels/coco_annotations_v1_merge_sub.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    batch_size=4,
    dataset=dict(
        ann_file='train/labels/coco_annotations_v1_ftmerge_sub.json',
        backend_args=None,
...
work_dir = '/home/cxc/mm-grounddino/smokefirecf_work_dir_loratrail'
