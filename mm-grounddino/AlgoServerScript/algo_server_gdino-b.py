...
def mAP_metric(server_ip):
    ...
    # pdb.set_trace()
    val_data = '/home/cxc/mm-grounddino/openness_checking_data/person_car_227'  #数据集测试格式和训练集一致
    # val_data = '/media/40T/cxc_mmdino/data/smoke_fire/test'
    
    names = OPEN_LABELS.open_names
    names_merge = OPEN_LABELS.open_names_mergeed_b1
    label_merge = True
    ...
    # prompt=['people', 'car', 'bicycle', 'pickup', 'bus', 'van', 'truck', 'train', 'tri wheeler', 'motorcycle', 'electric scooted vehicle','tire' , 'other vehicle',
    #         'reflection mirror', 'crane', 'tanker','agricultural tractor', 'spraying vehicle', 'application vehicle', 'fork lift vehicle', 'engineering vehicle', 'soil shifter', 
    #         'road roller', 'excavation vehicle', 'non motor vehicle','trolley']
    prompt=['people', 'car', 'bicycle', 'pickup', 'bus', 'van', 'truck', 'train', 'motorcycle', 'tire' , 
             'crane', 'tanker',  'trolley']
    # prompt_g1=prompt[:22]
