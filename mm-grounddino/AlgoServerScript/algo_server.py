...
def init_inferencer():
    ...
    # a=init_args.weights
    # a=a["state_dict"]
    checkpoint = torch.load(init_args.weights, map_location=torch.device('cpu'))
    print(type(checkpoint))
    # ck=checkpoint["state_dict"]
    print(init_args.weights)
...
def mAP_metric(server_ip):
    ...
    val_data = '/home/cxc/mm-grounddino/data/smoke_fire/test'  #数据集测试格式和训练集一致
